...
RULES = [
    ...
    },
    {
        "id": "FMT-007",
        "level": "SUGGESTION",
        "pattern": r'(?:174868|data-id=["\']174868["\'])',
        "message": "检测到低频特异的第三方拟物票根/回形针贴纸 END 模板（2026年全量推文中仅占0.46%孤例，且依赖第三方私有图片外链）。",
        "suggestion": "建议替换为官方推荐的纯 CSS 极简圆角微胶囊（data-component=\"end-marker\"），零外部图片依赖且100%跨平台稳定。"
    },
    # ==========================================
